    ...
    Examples:
        ...
        [
            Sauna(
                ...
                womans_room=WomansRoom(sauna_temperature=95.0, mizuburo_temperature=17.0),
...
def _extract_saunas(soup: BeautifulSoup) -> list[Sauna]:
    ...
    return [sauna(s) for s in soup.find_all(class_="p-saunaItem p-saunaItem--list")]
